...
nodes = [	
			[0,0,"NODE_A"],	[0,10,"NODE_B"], [10,0,"NODE_C"]#, [10,10,"NODE_K"], [5,40,"NODE_L"], [0,50,"NODE_M"],
			#[5,60,"NODE_D"], [0,70,"NODE_E"], [5,80,"NODE_F"]
		]
def main():
	global CURRTIME
	global nodes
	...
	while True:
		...
		YorN = raw_input("""C to create new entries for each node, Enter to continue, type in node names separated by spaces, P to plot, N to create a new node or Q to quit\n""")
		CURRTIME += 1
		if YorN == 'C':
			print
			createEntries()
